//Tic-Tac-Toe in C++ by Yashas Ranjan
...
int main()
{
    ...
    grid_print();       //print game grid

    while(!game_over()){     //if the game is not over
        player_choice();    //take player choice
        grid_update();      //fill the grid
